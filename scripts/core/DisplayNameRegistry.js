...
export class DisplayNameRegistry {
    ...
    static itemNames = new Map([
        ...
        ["minecraft:planks", "板材"],
        ["minecraft:log", "原木"],
        ["minecraft:wooden_slab", "木材のハーフブロック"],
        ["minecraft:wooden_pressure_plate", "木の感圧板"],
        ["minecraft:fence", "フェンス"],
        ["minecraft:fence_gate", "フェンスゲート"],
        ["minecraft:wooden_stairs", "木材の階段"],
        ["minecraft:trapdoor", "トラップドア"],
        ["minecraft:crafting_table", "作業台"],
        ["minecraft:bookshelf", "本棚"],
        ["minecraft:chest", "チェスト"],
        ["minecraft:jukebox", "ジュークボックス"],
        ["minecraft:note_block", "音符ブロック"],
        ["minecraft:huge_mushroom", "巨大キノコ"],
        ["minecraft:banner", "旗"],
        ["minecraft:bow", "弓"],
